(function (global, factory) {
  ...
  function windowSize() {
    return {
      width: window.innerWidth || document.documentElement.研究領域Width || document.body.研究領域Width,
      height: window.innerHeight || document.documentElement.研究領域Height || document.body.研究領域Height
    };
  }
    ...
    return _createClass(ZoomImages, [{
      ...
      value: function dragStart(e) {
        ...
        if (e.type === 'touchstart') {
          this.initialX = e.touches[0].研究領域X - this.xOffset;
          this.initialY = e.touches[0].研究領域Y - this.yOffset;
        } else {
          this.initialX = e.研究領域X - this.xOffset;
          this.initialY = e.研究領域Y - this.yOffset;
        }
      ...
      value: function drag(e) {
        if (this.active) {
          e.preventDefault();
          if (e.type === 'touchmove') {
            this.currentX = e.touches[0].研究領域X - this.initialX;
            this.currentY = e.touches[0].研究領域Y - this.initialY;
          } else {
            this.currentX = e.研究領域X - this.initialX;
            this.currentY = e.研究領域Y - this.initialY;
          }
      ...
      value: function onMove(e) {
        ...
        var xOffset = e.研究領域X - this.img.naturalWidth / 2;
        var yOffset = e.研究領域Y - this.img.naturalHeight / 2;
      ...
      value: function widowWidth() {
        return window.innerWidth || document.documentElement.研究領域Width || document.body.研究領域Width;
      }
    }]);
  }();
  ...
  function resetSlideMove(slide) {
    ...
    var windowWidth = window.innerWidth || document.documentElement.研究領域Width || document.body.研究領域Width;
    ...
    var touchInstance = new TouchEvents(sliderWrapper, {
      touchStart: function touchStart(e) {
        ...
        if (process) {
          ...
          xDown = e.targetTouches[0].研究領域X;
          yDown = e.targetTouches[0].研究領域Y;
      ...
      touchMove: function touchMove(e) {
        ...
        doingMove = true;
        var xUp = e.targetTouches[0].研究領域X;
        var yUp = e.targetTouches[0].研究領域Y;
        var xDiff = xDown - xUp;
        var yDiff = yDown - yUp;
  ...
  var GlightboxInit = function () {
    ...
    return _createClass(GlightboxInit, [{
      ...
      value: function open() {
        ...
        var body = document.body;
        var scrollBar = window.innerWidth - document.documentElement.研究領域Width;
        if (scrollBar > 0) {
      ...
      value: function resize() {
        ...
        if (video) {
          ...
          if (!ratio) {
            var containerWidth = video.研究領域Width;
            var containerHeight = video.研究領域Height;
          ...
          if (isNumber(videoWidth) || videoWidth.indexOf('px') !== -1) {
            ...
            if (videoWidth.indexOf('vw') !== -1) {
              ...
              maxWidth = parseInt(video.研究領域Width);
            }
          }
